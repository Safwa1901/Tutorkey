...
import 'package:flutter_application_1/view/home/users/tutee/mainTutee/browseTutee/browseTutee.dart';
import 'package:flutter_application_1/view/home/users/tutee/mainTutee/homeTutee/homeTutee.dart';
import 'package:flutter_application_1/view/home/users/tutee/mainTutee/sessionTutee/testwrapperTutee.dart';
import 'package:flutter_application_1/view/home/users/tutee/mainTutee/subjectTutee/subjectTutee.dart';
import 'package:flutter_application_1/view/home/users/tutee/mainTutee/subjectTutee/subjectWrapperTutee.dart';
...
class _TutorSection extends StatelessWidget {
  const _TutorSection({
    Key? key, // Updated to use nullable type in Dart's null-safety
    required this.yl,
...
class _MenuSection extends StatelessWidget {
  const _MenuSection({
    Key? key, // Updated to use nullable Key for null-safety
    required this.wy, // Use required for non-nullable fields
    required this.menu,
  }) : super(key: key);
...
class _ProfileSection extends StatelessWidget {
  const _ProfileSection({
    Key? key, // Use nullable Key for null-safety
    required this.wy, // Mark wy as required and non-nullable
    required this.profile, // Mark profile as required and non-nullable
  }) : super(key: key);
    ...
    return Container(
      ...
      child: TextButton(
        style: TextButton.styleFrom(
          ...
          backgroundColor:
              Colors.transparent, // Use if you want a transparent button
        ),
        onPressed: () async {
          await _auth.signOut();
        },
